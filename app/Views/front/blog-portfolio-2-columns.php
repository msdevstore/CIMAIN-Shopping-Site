			...
			<div class="breadbg">
				<div class="col-sm-12 text-center">
					...
					<ul>
						...
						<li> / </li>
						<li><a href="all-post.html" title="All Posts">All Posts</a></li>
						<li> / </li>
						<li><a title="Life Style">Life Style</a></li>
					</ul>
				</div>
			</div>
		</div>
...
<div class="blog">
	<div class="container-fluid">
		<div class="row">
			<!--============ Blog-Left ============-->
			<div class="col-sm-12 col-md-8 col-lg-8 padded">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-center">
					<a class="border" href="blogdetail2.html"><img class="img-responsive" alt="blog" src="assets/images/800x534.png"></a>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-center">
					<a class="border" href="blogdetail2.html"><img class="img-responsive" alt="blog" src="assets/images/800x534.png"></a>
				</div>
				...
				<div class="col-sm-12 text-center">
					<a href="#" title="Load More" class="button">Load More</a>
				</div>
				<hr>
			</div>
			<!--============ /Blog-Left ============-->
