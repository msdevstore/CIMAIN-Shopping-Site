	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 col-lg-12 text-center">
				<a class="border"><img src="assets/images/1100x570.png" alt="contact"></a>
				...
				<div class="col-sm-12 col-lg-8 col-lg-offset-2">
					<div class="location">
						...
						<div class="col-xs-12 col-sm-4 col-lg-4">
							...
							<h6>Address:</h6>
							<span>Abcd EfGHIJKL <br>GHIJKL</span>
						</div>
						<div class="col-xs-12 col-sm-4 col-lg-4">
					...
					<h6>Drop your suggestion, comment or just say hello!</h6>
					<p>I will be responding soon as possible.</p>
					<form>
